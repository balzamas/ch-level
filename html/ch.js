...
const messages = {
    English: {
        message: {
            ...
            data_level_4: 'Stayed Here (1 week +)',
            data_level_3: 'Stayed Here (1 night +)',
...
添加事件监控(图形,'click', e=>{
    ...
    设置等级标题.innerHTML = messages[Lang.textContent].canton_name[id]
...
const 保存图像 = _=>{
    ...
    地址变图像元素(数据地址,图=>{
        ...
        画板.toBlob(元素数据=>{
            ...
            下载文件(地址,`Switzerland Level 0.png`);
